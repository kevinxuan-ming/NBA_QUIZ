...
def frame12():
    ...
    options= ["View Score","Save score","Retry Quiz","Exit"]
...
def save_user_score():
    save_score()
    mess=Label(frame12,text="Your score has been saved!",bg='green',fg='white')
...
def save_score():
    with open('score.csv', 'a', newline='') as file:
        ...
        myfile.writerow([entryname.get(), score])
