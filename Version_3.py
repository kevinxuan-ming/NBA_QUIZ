...
def frame3():
    global score
    global first_page2
    #if answers correct adds 1 to theCB varible 'score'
    if entry1.get() =="C":
        print("Correct!")
        score = score + 1
    else:
